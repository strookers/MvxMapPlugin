...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "SampleMvxMapPlugin.Droid.dll" comes first in this list. */
		"SampleMvxMapPlugin.Droid.dll",
		...
		"MvxMapPlugin.dll",
		"MvxMapPlugin.Droid.dll",
		"SampleMvxMapPlugin.Core.dll",
